...
def get_variables():
    ...
    return (learning_rate, regularizer_1, regularizer_2, regularizer_3,
            regularizer_4, dropout_1, dropout_2)


def train_model_wrapper(learning_rate=0.00005, regularizer_1=0.001,
    ...
    filename_to_genre = {entry['filename']: entry['genre']
    ...
    class DataGenerator(Sequence):
        """Generates batches of training data, so all files don't have to be
    ...
    index_used = history.history['val_loss'].index(
